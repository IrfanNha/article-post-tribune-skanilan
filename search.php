...
<body>
  ...
  <div class="container my-5">
    ...
    if (isset($_GET['keyword'])) {
      ...
      // prepared statement untuk mengambil query posts
      $query = "SELECT * FROM posts WHERE judul LIKE ? OR isi LIKE ?";
    ...
    <?php
      ...
      echo "<div class='d-flex'><p class='mx-auto mt-5 fw-semibold'>Search Sesuatu.</p></div>";
    }
